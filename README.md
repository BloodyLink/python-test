...
NOTE: The email and slack reminders must contain an URL to today's menu with the following pattern http://nora.cornershop.io/menu/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx (an UUID), this page must not require authentication of any kind.
